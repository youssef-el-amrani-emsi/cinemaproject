...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initVilles() {
		Stream.of("Casablanca", "Marrakech", "Rabat", "Mohammedia").forEach(nameVille -> {
	...
	public void initFilms() {
		...
		Stream.of("Fight Club", "The Pursuit of Happyness", "Wandering Stars", "Scarface", "Training Day", "Goodfellas")
				.forEach(titreFilm -> {
					Film film = new Film();
